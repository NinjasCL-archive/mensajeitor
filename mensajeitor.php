...
<?php
 ...
 if (eregi($admin_nick,$nick) && $pass != $admin_pass) { $autentificado = "no"; }
 } 
 if(isset($autentificado) && $autentificado == "no") { echo "<span class=\"tabla\">Este nick no vale!!!!! <a href=\"javascript:history.back(1)\">Volver</a></span>"; exit; }
...
<?php 
		echo strip_tags($cacho_lectura[$i]); 
?>
		</td>
		</tr>
<?php 
