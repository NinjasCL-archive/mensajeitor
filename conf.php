<?php exit; ?>
 ...
 $NicksRegs = array("aaff:tupass","pepe:mipass","otronick:otropass");           // Aquí pon todos los nicks que estarán protegidos por contraseña "nick:contraseña", ATENCIÓN! BORRA LOS NICKS QUE NO VAYAS A UTILIZAR.

 $nick_defecto = "Tu Nick";       // Nick que saldrá por defecto al cargar mensajeitor

 $mensa_defecto = "Tu mensajete"; // Mensaje que saldrá por defecto al cargar mensajeitor
 ...
 $cantidad_mensajes = 30;         // Mensajes que se mostraran en el mensajeitor. -1 para mostarlos todos

 $mostrar_features = "ON";        // Muestra abajo del todo el autor y la configuración del script
...
////////////////////////////////////////////////////
  ...
  $divHeight = "100";     // En píxeles, altura del cuadro de mensajes
